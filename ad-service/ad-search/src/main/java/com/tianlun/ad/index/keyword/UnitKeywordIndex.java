package com.tianlun.ad.index.keyword;
...
public class UnitKeywordIndex implements IndexAware<String, Set<Long>> {
    ...
    private static Map<String, Set<Long>> keywordUnitMap; // Keyword to unit index map
    private static Map<Long, Set<String>> unitKeywordMap; // Unit to keyword index map
    ...
    public boolean match(Long unitId, List<String> keywords) {
        ...
        if (unitKeywordMap.containsKey(unitId) && CollectionUtils.isNotEmpty(unitKeywordMap.get(unitId))) {
            ...
            // Return true if keywords is subCollection of unitKeywords
