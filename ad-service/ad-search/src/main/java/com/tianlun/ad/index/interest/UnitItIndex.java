package com.tianlun.ad.index.interest;
...
public class UnitItIndex implements IndexAware<String, Set<Long>> {
    ...
    // <itTag, adUnitId set> 反向索引，通过itTag查找包含这条限制的推广单元
    private static Map<String, Set<Long>> itUnitMap;

    // <unitId, itTag set> 正向索引，通过unitid查找该推广单元的兴趣限制
    ...
    public void update(String key, Set<Long> value) {
        ...
        log.error("Update not supported in it index");
    }
