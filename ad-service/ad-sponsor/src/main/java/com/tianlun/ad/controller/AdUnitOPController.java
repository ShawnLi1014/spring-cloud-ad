...
public class AdUnitOPController {
    ...
    public AdUnit getAdUnitByUnitName(@RequestBody AdUnitGetRequest request) throws AdException {
        log.info("ad-sponsor: getAdUnitByUnitName -> {}", JSON.toJSONString(request));
        return adUnitService.getAdUnitByUnitName(request);
    }

    @PutMapping("/update/adUnit")
    public AdUnitResponse updateAdUnit(@RequestBody AdUnitRequest request) throws AdException {
        log.info("ad-sponsor: updateAdUnit -> {}", JSON.toJSONString(request));
        return adUnitService.updateAdUnit(request);
    }

    @DeleteMapping("/delete/adUnit")
    public void deleteAdUnit(@RequestBody AdUnitRequest request) throws AdException {
        log.info("ad-sponsor: deleteAdUnit -> {}", JSON.toJSONString(request));
        adUnitService.deleteAdUnit(request);
    }
